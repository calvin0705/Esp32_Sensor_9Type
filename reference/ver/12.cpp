...
// const char* mqtt_server_1 = "192.168.14.203";  ### smart phone
...
void task_temp() {
  ...
  Serial.println("str_topic_1 ========>> : " + str_topic_1);
  Serial.println("str_topic_2 ========>> : " + str_topic_2);
